...
public class TokenProvider {
	...
	public String createToken(Authentication authentication, boolean rememberMe) {
		...
		return Jwts.builder().setSubject(authentication.getName()).claim(AUTHORITIES_KEY, roles)
	...
	public Authentication getAuthentication(String token) {
		...
		Collection<? extends GrantedAuthority> roles = Arrays.stream(claims.get(AUTHORITIES_KEY).toString().split(","))
